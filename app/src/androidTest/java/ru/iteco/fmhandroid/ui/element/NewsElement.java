...
public class NewsElement {
    //Кнопка REFRESH
    public static ViewInteraction RefreshButton = onView(withId(R.id.news_retry_material_button));

    //Кнопка перехода в фильтрацию новостей
    public static ViewInteraction GoToFilterButton = onView(withId(R.id.filter_news_material_button));
